...
class Domain_Params:
    ...
    def __init__(self, X_length=400, Y_length=400, dx=2, dy=2, dz=1, nz=128, 
                 ...
                 shape_paths=None, QF_PATH='default', ToCopy_PATH='default', IG_PATH='default'):    
